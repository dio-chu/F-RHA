---
name: f-rha-radio
description: Use when the user wants to use, customize, or ask about the Radio component from the f-rha library. Covers radio group options (string array or object array), controlled selection, group label, layout (vertical/horizontal), and per-option or group-level disabled state.
---
...
| `layout`   | `"vertical" \| "horizontal"`                                         | `"vertical"` | Layout direction of radio options            |
...
// Simple string array (vertical layout)
<Radio
  name="framework"
...
- Added `layout` prop for vertical/horizontal orientation
